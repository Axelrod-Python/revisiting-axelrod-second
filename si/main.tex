...
\begin{table}[!hbtp]
    \resizebox{\textwidth}{!}{
    \centering
    \input{../paper/assets/original_strategies_rankings.tex}}
...
\begin{table}[!hbtp]
        ...
        \centering
        \input{../paper/assets/sp_tournament_full_rankings.tex}}
...
continuation probability, he sampled five different match lengths, and each
...
$1/151$. We use five different random seeds and, for each seed, repeat the
full tournament 1000 times. The results are shown in
Figure~\ref{fig:probabilistic_ending_tournament}.
...
\begin{figure}[!hbtp]
    \begin{center}
        ...
        text (Figure~1); however, we reproduce them here to allow for direct
