...
\affil[4]{Independent Researcher, Las Vegas, Nevada, USA}
...
\subsection*{Reviving the tournament.}
...
In \SI{} (\textbf{S10}), we consider the original set of players with a truly
...
Supplementary Figure~1. It is unclear whether this bug affected the tournament
...
of the rest of the top ten (see Supplementary Table~1).
...
\TFT{} won 63.3\% (Supplementary Table~1).
...
behaviour, is provided in the \SI~(S7, Supplementary Figure~5). In summary, the strategy has two states:
...
are included, after which improvements are small (Supplementary Figure~2.). This suggests that
...
\begin{table}[!hbtp]
        ...
        full list is provided in \SI{} (S5 and S8), and source code/documentation are
...
pattern of the original tournament. Supplementary Table~3
lists the top-performing strategies (see the \SI~(S4) for the full ranking). In
this new tournament, ZD strategies are distributed across the ranking rather than
concentrated at the top (\SI~(S4)), while \TFT{}, \texttt{k42r}, and generous variants
...
Supplementary Table~5 shows the top 16 strategies of the tournament.
...
Supplementary Figures~3 and~4. As expected, the
...
practices, code originally written in the 1980s. The archived materials~\cite{knight_2025_20811704} (at
\url{https://doi.org/10.5281/zenodo.20811704})
...
repository~\cite{knight_2025_20811704} at
\url{https://doi.org/10.5281/zenodo.20811704}. This archive includes the source
...
repository~\cite{knight_2025_20811704} at
\url{https://doi.org/10.5281/zenodo.20811704}, which provides a permanent and
...
% Main figures, grouped at the end per the journal layout requirements.
\clearpage
\begin{figure}[t]
  \begin{center}
...
\begin{figure}[!hbtp]
    \centering
    \includegraphics[width=.9\textwidth]{Figure_2.pdf}
...
\begin{figure}[!hbtp]
    \centering
    \includegraphics[width=.88\textwidth]{Figure_5.pdf}
...
\begin{figure}[!hbtp]
    \centering
    \includegraphics[width=.9\textwidth]{Figure_6.pdf}
