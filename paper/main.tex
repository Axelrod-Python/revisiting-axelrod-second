...
the \emph{original} 63 strategies. For each of the original strategies, that
have won at least once in these new tournaments, we show the probability of
...
\begin{table}[!hbtp]
        ...
        these eight strategies (noting that some wins accrue to other strategies
         not among the original entrants).}
