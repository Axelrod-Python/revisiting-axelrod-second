...
This is an excellent and important question. The original set of 63 submitted
...
We found this suggestion particularly important, as it allowed us both to
clarify the methodology of the extra invitations section and to better
understand the origin of the observed non-monotonic behavior.
...
The reviewer raises an important conceptual question regarding whether it is
possible to define an ``objective'' distribution of opponents for evaluating
strategies. In practice, the set of participating strategies determines the
...
We thank the reviewer for their recommendation and constructive feedback.
...
second tournament. However, the incomplete description of the match lengths in
...
Specifically, we consider a continuation probability corresponding to an average
match length of 151 turns.
...
with the original analysis, and \TFT{} continues to perform robustly. %ToDo
...
We thank the reviewer for asking for clarification. We have substantially
...
We thank the reviewer for spotting these issues. We have corrected the
...
We thank the reviewer for their strong recommendation of our work.
