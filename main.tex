...
\begin{table}[!hbtp]
        ...
        \caption{Top 15 strategies in the full tournament with 1\% noise. Strategies denoted with a \textdagger were trained using
        reinforcement learning~\cite{Harper2017}.}
\end{table}
...
The overall cooperation rates:

\begin{itemize}
    \item 1\%: \input{assets/noisy_tournament_overall_cooperation_rate_in_1_percent_noise.tex}
    \item 5\%: \input{assets/noisy_tournament_overall_cooperation_rate_in_5_percent_noise.tex}
\end{itemize}
