...
follows modern best practice and makes analysis more readable. This has all been
archived and is available at~\cite{owen_campbell_2017_834917}.
...
to as the \texttt{Axelrod\_fortran} library and is available at~\cite{}.
...
\(R^2=\input{assets/original_tournament_predictive_31_r_squared.tex}\)
...
\begin{table}[!hbtp]
        \centering
        \input{./assets/original_tournament_predictive_31_model.tex}
        \caption{Linear model best fitted to 31 strategies in the reproduced tournament
                 with
             \(R^2=\protect\input{assets/original_tournament_predictive_31_r_squared.tex}\)}
