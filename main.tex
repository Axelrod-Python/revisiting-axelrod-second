...
Prisoner's Dilemma.
% TODO Add description of magazine etc...
...
% TODO Add a citation for other languages
...
% TODO Include text and references about best practices in software.
...
\(R^2=\input{assets/original_tournament_predictive_17_r_squared.tex}\)
...
\begin{table}[!hbtp]
        \centering
        \input{./assets/original_tournament_predictive_17_model.tex}
        \caption{Linear model best fitted to 17 strategies in the reproduced tournament
                 with
             \(R^2=\protect\input{assets/original_tournament_predictive_17_r_squared.tex}\)}
...
% TODO Discuss these further tournaments
